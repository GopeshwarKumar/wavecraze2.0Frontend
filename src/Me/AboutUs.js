...
function AboutUs() {
  return (
    ...
    <div className='bg-gradient-to-tr from-blue-600 via-gray-900'>
      <motion.p initial={{opacity:1}} transition={{duration:2}} className='text-white md:px-[15vw] py-[4vh] vmd:px-[5vw] lg:text-[20px] sm:text-[17px] mb:text-[15px] vmd:text-[12px] opacity-0 font-serif '>
