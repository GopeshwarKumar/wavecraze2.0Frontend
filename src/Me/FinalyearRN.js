...
const people = [
  ...
  return (
    <>
    <motion.h1 initial={{translateY:40}} whileInView={{translateY:0,opacity:1}} transition={{duration:0.4}} className='organisingcomitee p-3 m-3 rounded-s-full font-bold text-center sm:text-[50px] vmd:text-[30px] mb:text-[40px] duration-200 transition-all shadow-2xl hover:shadow-rose-600'>Organising Comitee</motion.h1>
