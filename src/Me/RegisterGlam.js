...
const RegisterGlam=() => {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gradient-to-tr from-blue-600 via-gray-900 bg-slate-800">
      <h2 className="text-2xl mt-[5%] font-bold text-white text-center mb-6 ">Register for Glam It Up</h2>
      <form
      ...
      >
        ...
        <div className="mb-4">
          <label htmlFor="" className="block text-sm font-medium text-white">Department</label>
