...
function Footer() {
  return (
    ...
    <div className='w-full h-full bg-[#FF4E01] bg-gradient-to-tl from-blue-600 via-gray-900 to-slate-800  flex flex-col items-center justify-center p-3 rounded-br-full'>
            <h3 className='font-extrabold lg:text-[30px] sm:text-[27px] mb:text-[22px] text-white'>Thoughts about our Event ?</h3>
            <p className='font-bold text-white'>Just ask… if you dare <mark>!</mark></p><br/>
            <form className='flex flex-col items-center justify-center gap-2'>
                ...
                {/* <p className='text-[15px] vmd:px-3 sm:p-0 sm:text-[20px]'>About</p>
                    ...
                    <motion.label viewport={{once:true}} initial={{translateY:30}} whileInView={{translateY:0}} transition={{duration:0.4}} for="inputField" class="text-emerald-600 block text-lg font-medium  mb-2">Text</motion.label>
