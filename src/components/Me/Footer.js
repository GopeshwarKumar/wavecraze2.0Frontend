  ...
  return (
    ...
    <div className='w-full h-full bg-[#FF4E01] bg-gradient-to-tl from-blue-600 via-gray-900 to-slate-800  flex flex-col items-center justify-center p-3 rounded-br-full'>
            ...
            <form className='flex flex-col items-center justify-center gap-2'>
                ...
                <motion.label initial={{translateY:30}} whileInView={{translateY:0}} transition={{duration:0.4}} for="inputField" class="block text-lg font-medium text-emerald-700 mb-2">Enter your Name</motion.label>
                <input type="text" id="inputField" class="w-full p-3 border-b-4 outline-none hover:border-b-dotted hover:border-blue-400 text-gray-900 transition-all duration-100" placeholder="Type Name..."/>
                </div>
                <div>
                ...
                <motion.label initial={{translateY:30}} whileInView={{translateY:0}} transition={{duration:0.4}} for="inputField" class="block text-lg font-medium text-emerald-700 mb-2">Enter your Email</motion.label>
                <input type="text" id="inputField" class="w-full p-3 border-b-4 outline-none hover:border-b-dotted hover:border-blue-400 text-gray-900 transition-all duration-100" placeholder="Type Email..."/>
                </div>
                <div>
                {/* <p className='text-[15px] vmd:px-3 sm:p-0 sm:text-[20px]'>About</p>
                    ...
                    <motion.label initial={{translateY:30}} whileInView={{translateY:0}} transition={{duration:0.4}} for="inputField" class="text-emerald-600 block text-lg font-medium  mb-2">Text</motion.label>
                    <textarea type="text" id="inputField" class="w-full p-3 border-b-4 outline-none hover:border-b-dotted hover:border-blue-400 text-black transition-all duration-100" placeholder="Type message..."/>
                </div>
